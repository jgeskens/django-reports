...
SECRET_KEY = 'koz@&6&b*-%kau%24y^$f!7%w&pxqxq^hq92)l(t$1p=!2o)(3'
...
ROOT_URLCONF = 'advreport_test_project.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'advreport_test_project.wsgi.application'
